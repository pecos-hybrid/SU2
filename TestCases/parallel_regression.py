...
def main():
    ...
    square_cylinder.test_vals = [-1.166437, 0.076755, 1.398547, 2.196986] #last 4 columns
    ...
    pywrapper_turb_naca0012_sst.test_vals = [-12.589819, -5.489901, 1.059620, 0.019139] #last 4 columns
