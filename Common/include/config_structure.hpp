...
private:
  ...
  *Kind_GridMovement,    /*!< \brief Kind of the unsteady mesh movement. */
  ...
  unsigned short Kind_Trans_Model,			/*!< \brief Transition model definition. */
    Kind_FreeStreamTurbOption, Kind_ActDisk, Kind_Engine_Inflow, Kind_Inlet, *Kind_Inc_Inlet, *Kind_Inc_Outlet, *Kind_Data_Riemann, *Kind_Data_Giles;           /*!< \brief Kind of inlet boundary treatment. */
