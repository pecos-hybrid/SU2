...
enum ENUM_TIME_INT {
  ...
  RUNGE_KUTTA_LIMEX_SMR91 = 6,	/*!< \brief Linearly implicit Runge-Kutta w/ SMR 91 scheme. */
  RUNGE_KUTTA_LIMEX_EDIRK = 7	/*!< \brief Linearly implicit Runge-Kutta w/ EDIRK scheme. */
};
